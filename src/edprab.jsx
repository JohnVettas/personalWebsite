...
export function Education() {
    return (
        <>
            <div id='education' className="w-[90%] mx-auto font-bold titles-links">Education </div>
            <div className='w-[90%] mx-auto border-3  border-black-300 p-4 mb-4 bg-[#ffffff] text-[18px]' >
                <h1 className="text-4xl border-b-2 border-gray-500/50"><b>University of Piraeus</b></h1>
                <p className="pt-6 pl-6"><b>Bachelor of Science in Computer Science</b></p>
                <div>
                    <ul className="pb-4 space-y-2 list-disc list-inside text-gray-700 pl-6">
                ...
                <h1 className="text-4xl border-b-2 border-gray-500/50 mt-8"><b>Stockholm University</b></h1>
                <p className="pt-6 pl-6"><b>Bachelor of Science in Computer Science</b></p>
                <div>
                    <ul className="pb-4 space-y-2 list-disc list-inside pl-6">
                        ...
                        <li className="mt-2 list-none">
                            ...
                            {/* Inner list with left margin (ml-6) for indentation */}
                            <ul className="list-[circle] list-inside ml-6 mt-1 space-y-1">
                                <li>Engineered an <b>Edge AI</b> solution using TensorFlow Lite for Microcontrollers to deploy a sound
                                    classification model on an Arduino based UAV for <b>real-time animal species identification.</b> <a href="https://github.com/Doudman/Tiny-Machine-Learning" className="font-blue-500 hover:underline">(Github Repo)</a></li>
...
export function Projects() {
    return (
        <>
            <div id='projects' className="w-[90%] mx-auto font-bold titles-links">Projects </div>
            <div className='w-[90%] mx-auto border-3  border-black-300 p-4 mb-4 bg-[#ffffff] text-[18px]' >
                <h1 className="text-4xl border-b-2 border-gray-500/50"><b>Ds Dynamic Schedule</b></h1>
                <div className="pb-2 border-b-3 pt-6 grid grid-cols-1 min-[1300px]:grid-cols-[40%_60%]">

                    {/* 2. Changed the border: bottom border on mobile, right border on desktop */}
                    <div className="min-[1300px]:border-r-2 border-gray-500/50 pb-6 min-[1300px]:pb-0 min-[1300px]:pr-6">
                        <p className="mb-4">
                            ...
                            This project is still under development but it's very close to completion.
                            <a href="https://github.com/JiaJun0310/ds_dynamic_schedule" className="text-blue-500 hover:underline">
                                (Github Repo)
                            </a>
                        </p>
                        <ul className="pb-4 space-y-2 list-disc list-inside pl-2">
                    ...
                    <div className="flex items-center justify-center pl-3">
                        <img
                            ...
                            className="w-full h-auto max-w-4xl border-2 border-[#00bcd4] rounded-lg shadow-md"
                        />
                    </div>
                ...
                <h1 className="mt-4 text-4xl border-b-2 border-gray-500/50"><b>Weather App</b></h1>
                <div className="pb-2 border-b-3 pt-6 grid grid-cols-1 min-[1300px]:grid-cols-[40%_60%]">
